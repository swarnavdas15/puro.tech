    ...
    <section className="relative min-h-screen w-full bg-gradient-to-br from-black via-[#140406] to-black overflow-hidden flex items-center">
      ...
      <div className="relative max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        <div className="space-y-10">
          ...
          <div className="relative max-w-md bg-white/5 backdrop-blur-xl border border-white/15 rounded-2xl px-8 py-6">
          ...
          <div className="flex gap-4 pt-4">
            <Link
              to="/"
              className="
                px-8 py-3 rounded-full bg-gradient-to-br from-red-500 to-red-700
            ...
            <Link
              to="/contact"
              className="
                px-8 py-3 rounded-full border border-white/30 text-white/80
        ...
        <div className="flex justify-center lg:justify-end relative">
          <img
            ...
            draggable={false}
            className="
              w-64 sm:w-72 md:w-80 drop-shadow-[0_50px_100px_rgba(0,0,0,0.8)] select-none
            "
          />
