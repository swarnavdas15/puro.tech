...
export default function PortfolioHero() {
  return (
    <>
    <section className="relative w-full min-h-[88vh] bg-gradient-to-br from-black via-[#140406] to-black overflow-hidden">
      ...
      {/* MAIN CONTENT */}
      <div className="relative  max-w-7xl mx-auto px-96 pt-44">
        ...
        {/* DOT CLUSTER – RIGHT */}
        <div className="absolute right-[120px] top-[38%] grid grid-cols-3 gap-2">
        ...
        {/* DOT CLUSTER – LEFT */}
        <div className="absolute left-[260px] top-[100%] grid grid-cols-3 gap-2">
          {Array.from({ length: 9 }).map((_, i) => (
            <span key={i} className="w-2.5 h-2.5 rounded-full bg-red-600" />
          ))}
        </div>
